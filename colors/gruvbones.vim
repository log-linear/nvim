...
if &background ==# 'dark'
    ...
    highlight PreProc guifg=#82C07B guibg=NONE guisp=NONE gui=NONE cterm=NONE
    ...
    highlight Normal guifg=#3C3836 guibg=#F9F5D6 guisp=NONE gui=NONE cterm=NONE
    highlight Bold guifg=NONE guibg=NONE guisp=NONE gui=bold cterm=bold
    ...
    highlight! link WhichKeyValue Constant
    highlight! link helpOption Constant
    highlight Cursor guifg=#F9F5D6 guibg=#3C3836 guisp=NONE gui=NONE cterm=NONE
    highlight! link TermCursor Cursor
    ...
    highlight IncSearch guifg=#F9F5D6 guibg=#D771AE guisp=NONE gui=bold cterm=bold
    highlight! link CurSearch IncSearch
    highlight Italic guifg=NONE guibg=NONE guisp=NONE gui=italic cterm=italic
    ...
    highlight PreProc guifg=#427B58 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    ...
    highlight Todo guifg=NONE guibg=NONE guisp=NONE gui=bold,underline cterm=bold,underline
    highlight Type guifg=#3c3836 guibg=NONE guisp=NONE gui=italic cterm=NONE
    highlight! link helpSpecial Type
    highlight! link markdownCode Type
    highlight Underlined guifg=NONE guibg=NONE guisp=NONE gui=underline cterm=underline
    highlight Visual guifg=NONE guibg=#E0DCDA guisp=NONE gui=NONE cterm=NONE
    highlight WarningMsg guifg=#3c3836 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    highlight! link DiagnosticWarn WarningMsg
    highlight! link gitcommitOverflow WarningMsg
    highlight WhichKeySeparator guifg=#A19C74 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    highlight WildMenu guifg=#F9F5D6 guibg=#903F71 guisp=NONE gui=NONE cterm=NONE
    highlight! link SneakLabel WildMenu
    ...
    highlight lCursor guifg=#F9F5D6 guibg=#615B58 guisp=NONE gui=NONE cterm=NONE
    highlight! link TermCursorNC lCursor
