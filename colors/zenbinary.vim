...
if &background ==# 'dark'
    ...
    highlight! link CocWarningVirtualText DiagnosticVirtualTextWarn
    highlight! link DiagnosticDeprecated DiagnosticWarn
    highlight DiagnosticUnnecessary guibg=#DDDDDD
    highlight! link NotifyWARNIcon DiagnosticWarn
    highlight! link NotifyWARNTitle DiagnosticWarn
    ...
    highlight FloatTitle guifg=#000000 guibg=#D7D7D7 guisp=NONE gui=bold cterm=bold
    ...
    highlight! link PreProc Statement
    highlight! link WhichKey Statement
    highlight StatusLine guifg=#000000 guibg=#CFCFCF guisp=NONE gui=NONE cterm=NONE
    highlight! link TabLine StatusLine
    highlight! link WinBar StatusLine
