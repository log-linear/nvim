" Modified zenwritten scheme
if exists('g:colors_name')
    highlight clear
endif

let g:colors_name = 'zenbinary'
...
if &background ==# 'dark'
    ...
    highlight Normal guifg=#BBBBBB guibg=#000000 guisp=NONE gui=NONE cterm=NONE
    highlight! link ModeMsg Normal
    highlight Bold guifg=NONE guibg=NONE guisp=NONE gui=bold cterm=bold
    highlight Boolean guifg=#BBBBBB guibg=NONE guisp=NONE gui=italic cterm=italic
    highlight BufferVisible guifg=#dfdfdf guibg=NONE guisp=NONE gui=NONE cterm=NONE
    highlight BufferVisibleIndex guifg=#dfdfdf guibg=NONE guisp=NONE gui=NONE cterm=NONE
    highlight BufferVisibleSign guifg=#dfdfdf guibg=NONE guisp=NONE gui=NONE cterm=NONE
    highlight CocMarkdownLink guifg=#66A5AD guibg=NONE guisp=NONE gui=underline cterm=underline
    highlight ColorColumn guifg=NONE guibg=#555555 guisp=NONE gui=NONE cterm=NONE
    ...
    highlight Cursor guifg=#000000 guibg=#C9C9C9 guisp=NONE gui=NONE cterm=NONE
    highlight! link TermCursor Cursor
    highlight CursorLine guifg=NONE guibg=#444444 guisp=NONE gui=NONE cterm=NONE
    ...
    highlight Folded guifg=#A3A3A3 guibg=#000000 guisp=NONE gui=NONE cterm=NONE
    ...
    highlight IncSearch guifg=#000000 guibg=#BF8FB5 guisp=NONE gui=bold cterm=bold
    ...
    highlight LspInlayHint guifg=#7A6569 guibg=#444444 guisp=NONE gui=NONE cterm=NONE
    ...
    highlight RenderMarkdownCode guifg=NONE guibg=#444444 guisp=NONE gui=NONE cterm=NONE
    ...
    highlight StatusLineNC guifg=#dfdfdf guibg=#242424 guisp=NONE gui=NONE cterm=NONE
    ...
    highlight WildMenu guifg=#000000 guibg=#B279A7 guisp=NONE gui=NONE cterm=NONE
    ...
    highlight lCursor guifg=#000000 guibg=#7F7F7F guisp=NONE gui=NONE cterm=NONE
    ...
    highlight Normal guifg=#000000 guibg=#FFFFFF guisp=NONE gui=NONE cterm=NONE
    highlight! link NormalNC Normal
    highlight! link ModeMsg Normal
    highlight Bold guifg=NONE guibg=NONE guisp=NONE gui=bold cterm=bold
    highlight Boolean guifg=#000000 guibg=NONE guisp=NONE gui=italic cterm=italic
    ...
    highlight ColorColumn guifg=NONE guibg=#e8e5e5 guisp=NONE gui=NONE cterm=NONE
    highlight! link LspReferenceRead ColorColumn
    highlight! link LspReferenceText ColorColumn
    highlight! link LspReferenceWrite ColorColumn
    ...
    highlight! link WhichKeyValue Constant
    highlight! link helpOption Constant
    highlight Cursor guifg=#FFFFFF guibg=#000000 guisp=NONE gui=NONE cterm=NONE
    highlight! link TermCursor Cursor
    highlight CursorLine guifg=NONE guibg=#f6f6f6 guisp=NONE gui=NONE cterm=NONE
    highlight! link CocMenuSel CursorLine
    highlight! link CursorColumn CursorLine
    highlight! link FzfLuaFzfCursorLine CursorLine
    highlight CursorLineNr guifg=#000000 guibg=NONE guisp=NONE gui=bold cterm=bold
    ...
    highlight! link CocWarningVirtualText DiagnosticVirtualTextWarn
    highlight! link DiagnosticDeprecated DiagnosticWarn
    highlight DiagnosticUnnecessary guibg=#eeeeee
    highlight! link NotifyWARNIcon DiagnosticWarn
    highlight! link NotifyWARNTitle DiagnosticWarn
    ...
    highlight! link diffRemoved DiffDelete
    highlight DiffText guifg=#000000 guibg=#A9BED1 guisp=NONE gui=NONE cterm=NONE
    highlight Directory guifg=NONE guibg=NONE guisp=NONE gui=bold cterm=bold
    ...
    highlight FlashLabel guifg=#000000 guibg=#8FCAF6 guisp=NONE gui=NONE cterm=NONE
    highlight FloatBorder guifg=#6F6F6F guibg=NONE guisp=NONE gui=NONE cterm=NONE
    highlight FloatTitle guifg=#000000 guibg=#e8e8e8 guisp=NONE gui=bold cterm=bold
    ...
    highlight Function guifg=#505050 gui=bold
    highlight! link TroubleNormal Function
    highlight! link TroubleText Function
    ...
    highlight! link GitGutterDelete GitSignsDelete
    "highlight! IndentBlanklineContextChar guifg=#000000 gui=nocombine
    ...
    highlight IncSearch guifg=#FFFFFF guibg=#C074B2 guisp=NONE gui=bold cterm=bold
    highlight! link CurSearch IncSearch
    highlight Italic guifg=NONE guibg=NONE guisp=NONE gui=italic cterm=italic
    ...
    highlight Search guifg=#000000 guibg=#DEB9D6 guisp=NONE gui=NONE cterm=NONE
    highlight! link CocSearch Search
    highlight! link MatchParen Search
    highlight! link QuickFixLine Search
    highlight! link Sneak Search
    ...
    highlight Statement guifg=#000000 guibg=NONE guisp=NONE gui=bold cterm=bold
    highlight! link FzfLuaBufName Statement
    highlight! link PreProc Statement
    highlight! link WhichKey Statement
    highlight StatusLine guifg=#000000 guibg=#dfdfdf guisp=NONE gui=NONE cterm=NONE
    highlight! link TabLine StatusLine
    highlight! link WinBar StatusLine
    highlight StatusLineNC guifg=#686868 guibg=#eeeeee guisp=NONE gui=NONE cterm=NONE
    highlight! link TabLineFill StatusLineNC
    highlight! link WinBarNC StatusLineNC
    highlight TabLineSel guifg=NONE guibg=NONE guisp=NONE gui=bold cterm=bold
    highlight! link BufferCurrent TabLineSel
    highlight Title guifg=#000000 guibg=NONE guisp=NONE gui=bold cterm=bold
    highlight! link FzfLuaTitle Title
    highlight Todo guifg=NONE guibg=NONE guisp=NONE gui=bold,underline cterm=bold,underline
    highlight Type guifg=#151515 gui=italic
    highlight! link helpSpecial Type
    highlight! link markdownCode Type
    highlight Underlined guifg=NONE guibg=NONE guisp=NONE gui=underline cterm=underline
    ...
    highlight lCursor guifg=#FFFFFF guibg=#595959 guisp=NONE gui=NONE cterm=NONE
    highlight! link TermCursorNC lCursor
