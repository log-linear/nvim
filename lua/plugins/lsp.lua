    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(ev)
          ...
          vim.keymap.set('n', 'gri', vim.lsp.buf.implementation, { buffer = ev.buf, desc = "LSP: Go to implementation" })
          vim.keymap.set({'n', 'i'}, '<C-s>', vim.lsp.buf.signature_help, { buffer = ev.buf, desc = "LSP: Signature help" })
          ...
          vim.keymap.set({ 'n', 'v' }, 'gra', vim.lsp.buf.code_action, { buffer = ev.buf, desc = "LSP: Show code actions" })
          -- vim.keymap.set({"n"}, "gO", vim.lsp.buf.document_symbol(), { buffer = ev.buf, desc = "LSP: Show document symbols" })
