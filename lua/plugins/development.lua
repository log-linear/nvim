...
return {
  ...
  -------------------------------- Debugging -----------------------------------
  {
    ...
    keys = {
      ...
      { "<Leader>dr",  ":lua require'dap'.repl.open()<CR>",                 desc = "DAP: Open REPL" },
      { "<Leader>dl",  ":lua require'dap'.run_last()<CR>",                  desc =
      "DAP: Run last debugging session configuration" },
