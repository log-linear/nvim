...
map("i", ";B", "<esc>0D83A=<esc>0:exec 'normal! 0R' . &cms<cr>a<bs><bs><bs><esc>o<bs><esc>0C", opts)
map("i", ";b", "<esc>0D83A-<esc>0:exec 'normal! 0R' . &cms<cr>a<bs><bs><bs><esc>o<bs><esc>0C", opts)
map("i", ";H", "<esc>:center<cr>2hv0r=A<space><esc>40A=<esc>d83<bar>0:exec 'normal! 0R' . &cms<cr>a<bs><bs><bs><esc>o<bs><esc>0C", opts)
map("i", ";h", "<esc>:center<cr>2hv0r-A<space><esc>40A-<esc>d83<bar>0:exec 'normal! 0R' . &cms<cr>a<bs><bs><bs><esc>o<bs><esc>0C", opts)
