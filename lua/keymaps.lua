...
map("i", ";B", "<esc>0D80A=<esc>0:exec 'normal! 0r' . '&cms<cr>o<bs>'", opts)
map("i", ";b", "<esc>0D80A-<esc>0:exec 'normal! 0r' . '&cms<cr>o<bs>'", opts)
map("i", ";H", "<esc>:center<cr>2hv0r=A<space><esc>40A=<esc>d80<bar>0:exec normal! 0r . &cms<cr><esc>o<bs>", opts)
map("i", ";h", "<esc>:center<cr>2hv0r-A<space><esc>40A-<esc>d80<bar>0:exec normal! 0r . &cms<cr><esc>o<bs>", opts)
map("i", ";todo", "<esc>:exec normal! 0i . &cms[0]<cr>$a TODO: ", opts)
