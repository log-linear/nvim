...
map("n", "<leader>tt", [[:15new<CR><C-\><C-n>:call termopen($SHELL)<CR>:set nobl<CR><C-w>k]],                                             { desc = "Open a new terminal" })
map("n", "<leader>tp", [[:15new<CR><C-\><C-n>:call termopen('python')<CR>:set nobl<CR><C-w>k]],                                           { desc = "Open a new Python console" })
map("n", "<leader>tr", [[:15new<CR><C-\><C-n>:call termopen('radian')<CR>:set nobl<CR><C-w>k]],                                           { desc = "Open a new R console" })
